    ...
    <div className="flex flex-col gap-4 relative">
      <div className="rounded-md">
        <picture>
          ...
          <img src={image.mobile} alt={category} className="w-full h-full object-cover rounded-md" />
        </picture>
      </div>
      <div className="relative flex items-center justify-center">
        <button className="absolute -top-8 flex items-center justify-center px-4 py-2 rounded-full
        bg-white gap-2 text-sm border border-rose-500">
          <svg
